    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (userID.compareToIgnoreCase(loginUser.getUserID()) == 0) {
                request.setAttribute("ERROR_MESSAGE", "Error: Cannot delete user is login !!!");
            } else {
            ...
            if(e.toString().contains("REFERENCE constraint")){
                request.setAttribute("ERROR_MESSAGE", "Error: Cannot delete user is referenced on Database");
            }
        } finally {
